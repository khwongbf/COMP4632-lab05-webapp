...
<head>
    ...
    <script type="text/javascript">
        function validateVote() {
            ...
            if (document.querySelectorAll('input[name="radio_topic"]:checked').length <= 0) {
                errmsg += "Topic is not selected!<br />";
            }

            if (document.querySelectorAll('input[name="radio_option"]:checked').length <= 0) {
                errmsg += "Option is not selected!<br />";
            }
